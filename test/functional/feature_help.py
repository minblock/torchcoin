...
"""Verify that starting torchcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start torchcoin with -h for help text")
        ...
        self.log.info("Start torchcoin with -version for version information")
        ...
        self.log.info("Start torchcoind with -fakearg to make sure it does not start")

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " torchcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  torchcoin-tx [options] <hex-tx> [commands]  Update hex-encoded torchcoin transaction\n" +
            "or:     torchcoin-tx [options] -create [commands]   Create hex-encoded torchcoin transaction\n" +
            "\n";

# Support for Output Descriptors in Torchcoin Core

Since Torchcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Torchcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Torchcoin Core wallets, a convenience function `combo` is
